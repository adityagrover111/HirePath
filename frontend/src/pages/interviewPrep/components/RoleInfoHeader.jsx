  ...
  return (
    <div className="bg-white relative">
      <div className="container mx-auto px-10 md:px-0">
        <div className="h-[200px] md:pl-4 flex flex-col justify-center relative z-10">
          <div className="flex items-start">
            <div className="flex-grow">
              <div className=" flex justify-between items-start ">
                <div>
                  <h2 className="text-2xl md:pl-3 font-medium">{role}</h2>
                  <p className="text-sm md:pl-3 text-medium text-gray-900 mt-1">
                    {topicsToFocus}
                  </p>
                </div>
              </div>
          ...
          <div className="flex md:pl-3 items-center gap-3 z-0 mt-4">
        ...
        <div className="w-[40w] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
